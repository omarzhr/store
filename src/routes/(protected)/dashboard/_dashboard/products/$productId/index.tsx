...
export const Route = createFileRoute('/(protected)/dashboard/_dashboard/products/$productId/')({
  loader: async ({ params }) => {
    try {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-3 sm:p-4 lg:p-6 max-w-7xl mx-auto pb-20 lg:pb-8">
        ...
        {/* Enhanced Description Section - Fixed width overflow */}
        {product.description && (
          <Card className="mt-4 sm:mt-6 lg:mt-8">
            ...
            <CardContent className="overflow-hidden">
              <div 
                className="prose prose-sm max-w-none text-gray-700 prose-headings:text-gray-900 prose-links:text-primary [&>*]:text-sm sm:[&>*]:text-base [&>*]:break-words [&>*]:overflow-wrap-break-word [&_img]:max-w-full [&_img]:h-auto [&_table]:block [&_table]:overflow-x-auto [&_table]:whitespace-nowrap [&_pre]:overflow-x-auto [&_pre]:max-w-full [&_code]:break-all"
                style={{
